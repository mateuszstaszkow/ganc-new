export const pl = {
  ...
  ui: {
    ...
    language: 'Język',
    footerNav: 'Stopka — nawigacja',
    page: 'Strona',
    info: 'Informacje',
    privacy: 'RODO — ochrona danych osobowych',
    recruitment: 'Rekrutacja',
    previousSite: 'Poprzednia wersja strony',
    home: 'Strona główna',
    notFoundKicker: 'Błąd 404',
    notFoundTitle: 'Nie znaleziono strony',
    notFoundLead: 'Ten adres nie istnieje lub został przeniesiony.',
